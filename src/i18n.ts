...
export const copy: Record<Lang, Copy> = {
  ...
  ru: {
    ...
    yearToDate: "год пользователя по сегодня",
    yearToDateMovies: "год пользователя в фильмах по сегодня",
    yearToDateSeries: "год пользователя в сериалах по сегодня",
...
export function namedCopy(lang: Lang, names: DisplayNames): Copy {
  ...
  return {
    ...base,
    displayName: ru,
    yearToDate: `год ${gen} по сегодня`,
    yearToDateMovies: `год ${gen} в фильмах по сегодня`,
    yearToDateSeries: `год ${gen} в сериалах по сегодня`,
